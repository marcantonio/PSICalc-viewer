class ClusteringResults:
    def __init__(self, clusterMap, columnMap, lowEntropy, mergedMsa):
        self.clusterMap = clusterMap
        self.columnMap = columnMap
        self.lowEntropySites = lowEntropy
    ...
    def fromDict(cls, rDict):
        ...
        lowEntropy = rDict["low_entropy_sites"]
        del rDict["low_entropy_sites"]
        mergedMsa = rDict["merged_msa"]
        del rDict["merged_msa"]
        return cls(rDict, columnMap, lowEntropy, mergedMsa)
